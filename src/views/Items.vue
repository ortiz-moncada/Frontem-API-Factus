  ...
  <div class="Contenedor">
            ...
            <div class="contem-in-the-card">
              ...
              <div class="contem-the-imputs">
                <div class="contem1">
                  ...
                  <label>PRECIO</label>
                  <q-input v-model="precio" standout="bg-teal text-white" label="ingrese valor del producto"
                    type="number" />
                </div>

                <div class="contem2">
                  <label>CODIGO DE REFERENCIA</label>
                  <q-input v-model="codigoReferencia" standout="bg-teal text-white" label="Ingrese codigo del producto"
                    type="number" />
                  <br><br>
                </div>
                ...
                <div class="contem3">
                  ...
                  <q-input v-model="impuesto" standout="bg-teal text-white" label="Ingrese inpuesto del producto"
                    type="number" />
                  <br><br>
                </div>
              </div>
      ...
      <q-markup-table dark class="bg-indigo-8">
        ...
        <tbody>
          <tr v-for="(items, index) in items" :key="index">
            ...
            <td class="text-left">{{ items.cantidad }}</td>
            <td class="text-right">{{ items.precio }}</td>
            <td class="text-right">{{ items.impuesto }}</td>
            <td class="text-right">
              <q-btn icon="visibility" color="blue-4" flat @click="verItem(index)" />
              <q-btn icon="edit_square" color="blue-7" flat @click="editarItem(index)" />
            </td>
          </tr>
        </tbody>
      </q-markup-table>
    ...
    <q-layout view="hHh lpR fFf">
      ...
      <q-drawer v-model="rightDrawerOpen" side="right" bordered>
        <div class="caja1">
          <img class="imagen"
            src="https://img.freepik.com/vector-gratis/gradiente-verde-ola-3d-lujo-fondo-oscuro-abstracto-moderno_343694-3033.jpg?semt=ais_hybrid"
            alt="">
...
function registrar() {
  if (!nombre.value || !precio.value || !id.value || !impuesto.value) {
